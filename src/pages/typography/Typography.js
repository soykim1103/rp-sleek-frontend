      ...
      <div>
              ...
              <Row>
                ...
                <Col xs={12} xl={6} className="mt-5 mt-xl-0">
                  ...
                  <p className="body-3 text-muted">
                    ...
                    which give an impression of both modernism, harmony and
                    roundness. These nuances give Rapyd_Sleek a harmonious and
                    sensible appearance for both texts and headlines.{" "}
                  </p>
                  <p className="body-3 text-muted">
                    This typeface is a complete redesign of Rapyd_Sleek
                    initially designed in 2008. this typeface supports a wide
                    range of languages with more than 500 glyphs.{" "}
                  </p>
                </Col>
              </Row>
            </Widget>
        ...
        <Row className="gutter">
          <Col className="mb-4" xs={12} lg={6}>
            <Widget
              ...
              title={
                <p className="headline-2 mb-0 text-muted">
                  Semi-Bold Headings{" "}
                </p>
              }
            >
          ...
          <Col className="mb-4" xs={12} lg={6}>
            ...
            >
              <h1 className="font-weight-bold mb-4">
                h1 40px h1. Heading Title
              </h1>
              <h2 className="font-weight-bold mb-4">
                h2 32px h2. Heading Title
              </h2>
              <h3 className="font-weight-bold mb-4">
                h3 28px h3. Heading Title
              </h3>
              <h4 className="font-weight-bold mb-4">
                h4 24px h4. Heading Title
              </h4>
              <h5 className="font-weight-bold mb-4">
                h5 20px h5. Heading Title
              </h5>
        ...
        <Row>
          <Col className="mb-4">
            <Widget
              className="widget-p-lg"
              title={<p className="headline-2 mb-0 text-muted">Body Text</p>}
            >
              <p className="mb-0">
                In ultricies fermentum aliquet. Pellentesque dui magna,
                condimentum non ullamcorper at, cursus in sem. Nunc condimentum,
                purus ac sagittis ultricies, metus leo pharetra mi, non vehicula
                felis elit et nisi. Etiam venenatis commodo libero, vel
                ullamcorper nibh lobortis vel. Aliquam auctor porta tortor, nec
                consequat nibh finibus a. Sed ultrices risus eget iaculis
                luctus. Mauris vel gravida magna.
              </p>
            </Widget>
          </Col>
        </Row>
